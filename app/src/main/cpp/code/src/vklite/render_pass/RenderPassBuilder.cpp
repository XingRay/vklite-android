...
namespace vklite {
    ...
    std::unique_ptr<RenderPass> RenderPassBuilder::buildUnique(const Device &device) {
        ...
        return std::make_unique<RenderPass>(device, attachmentDescriptions, vkSubpassDescriptions, subpassDependencies);
    }
...
//        return RenderPass(device, attachmentDescriptions, vkSubpassDescriptions, subpassDependencies);
        return {device, attachmentDescriptions, vkSubpassDescriptions, subpassDependencies};
    }
