...
namespace vklite {
    ...
    PipelineLayout::PipelineLayout(const Device &device,
        ...
        for (const auto &bindingSet: descriptorSetLayoutBindingSets) {
            vk::DescriptorSetLayoutCreateInfo descriptorSetLayoutCreateInfo{};
            descriptorSetLayoutCreateInfo
                    .setBindings(bindingSet);

            vk::DescriptorSetLayout descriptorSetLayout = vkDevice.createDescriptorSetLayout(descriptorSetLayoutCreateInfo);
