...
//    DescriptorImmutableSamplerConfigure::DescriptorImmutableSamplerConfigure(
...
//
//    DescriptorImmutableSamplerConfigure::~DescriptorImmutableSamplerConfigure() = default;
//
//    std::unique_ptr<ImageInfo> DescriptorImmutableSamplerConfigure::provideDescriptorImageInfo(const Device &device, const CommandPool &commandPool) {
