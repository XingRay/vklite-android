...
namespace vklite {
    ...
    std::unique_ptr<ImageInfo> VulkanDescriptorImageInfoConfigure::provideVulkanDescriptorImageInfo(const Device &vulkanDevice, const VulkanCommandPool &commandPool) {
