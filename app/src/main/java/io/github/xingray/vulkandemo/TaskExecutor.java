...
public class TaskExecutor {
     ...
     * IO读写线程池,最多二个同时执行
     */
    public static final ExecutorService sIOPool;

    /**
     * 全局cachePool,适用于AsyncHttpClient等不
     * 限制任务数的请求
     */
    public static final ExecutorService sCachePool;

    /**
     * 串行线程池
     */
    public static final ExecutorService sSerialPool;

    /**
     * 繁重 任务线程池，适用于像ImageLoader转换图像这种时间不长但又很占CPU的任务
     * 排队执行的ThreadPool,核心线程为CORE_POOL_SIZE+1个
     */
    public static final ExecutorService sCpuPool;
